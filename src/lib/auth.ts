  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials) {
        ...
        console.log(`[Auth-DEBUG] Login attempt: ${email}, password length: ${password.length}`)
        ...
        if (!user.passwordHash) {
          console.log(`[Auth-DEBUG] User has no passwordHash: ${email}`)
          return null
        }
        ...
        try {
          ...
          console.log(`[Auth-DEBUG] bcrypt error:`, err)
        }
